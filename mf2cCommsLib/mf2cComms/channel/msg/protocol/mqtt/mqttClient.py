...
#                payload_str = json.dumps(payload_dict)
    ...
    def topic_public(myName):
        logging.debug("DEBUG - topic is mf2c/%s/public", str(myName))
        return 'mf2c/' + str(myName) + '/public'
    
    # static methods are referenced as <class>.<method>
    @staticmethod
    def topic_protected(myName):
        logging.debug("DEBUG - topic is mf2c/%s/protected", str(myName))
        return 'mf2c/' + str(myName) + '/protected'
        
    # static methods are referenced as <class>.<method>
    @staticmethod
    def topic_private(myName):
        logging.debug("DEBUG - topic is mf2c/%s/private", str(myName))
        return 'mf2c/' + str(myName) + '/private'
        
    # static methods are referenced as <class>.<method>
    @staticmethod
    def topic_pingreq(myName):
        logging.debug("DEBUG - topic is mf2c/%s/public/pingreq", str(myName))
        return 'mf2c/' + str(myName) + '/public/pingreq'
    
    # static methods are referenced as <class>.<method>
    @staticmethod
    def topic_pingack(myName):
        logging.debug("DEBUG - topic is mf2c/%s/public/pingack", str(myName))
        return 'mf2c/' + str(myName) + '/public/pingack'
    
    # static methods are referenced as <class>.<method>
    @staticmethod
    def topic_status():
        logging.debug("DEBUG - topic is mf2c/broker_services/status")
        return 'mf2c/broker_services/status'
    
    # static methods are referenced as <class>.<method>
    @staticmethod
    def topic_handshake(myName):
        logging.debug("DEBUG - topic is mf2c/%s/public/handshake", str(myName))
        return 'mf2c/' + str(myName) + '/public/handshake'
