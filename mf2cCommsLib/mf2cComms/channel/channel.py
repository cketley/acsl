...
from mf2cComms.channel.protocolType import ProtocolType
from mf2cComms.channel.qosType import QosType
from mf2cComms.channel.secType import SecurityType
from mf2cComms.channel.gdprType import GdprType
from mf2cComms.channel.msg.message import Message
#from mf2cComms.channel.identity import Identity
#from mf2cComms.listener.listener import Listener
#from mf2cComms.channel.pingService import PingService
#from mf2cComms.received.receivedMessage import ReceivedMessage

from mf2cComms.channel.msg.protocol.mqtt.mqttClient import MqttClient
from mf2cComms.channel.msg.protocol.mqtt.mqttSmartAgent import MqttSmartAgent
from mf2cComms.channel.msg.protocol.mqtt.mqttBrokerServices import MqttBrokerServices

from mf2cComms.channel.msg.protocol.lorawan.loraClient import LoraClient
from mf2cComms.channel.msg.protocol.http.httpClient import HttpClient
from mf2cComms.channel.msg.protocol.ble.bleClient import BleClient
from mf2cComms.channel.msg.protocol.sigfox.sigfoxClient import SigfoxClient

from mf2cComms.channel.msg.protocol.protocol import Protocol

from mf2cComms.config import Config
from mf2cComms.channel.identity import Identity
from mf2cComms.received.receivedMessage import ReceivedMessage
...
import socket
import sys
#from mf2cDemoAlice2Bob.mf2cDemoAlice2Bob import friendlyName
...
#        self.objPinger = PingService(friendlyName)
    ...
    def __prepProtocol(self, toNode, fromNode, transport, friendlyName ):
        ...
        dictParams = {}
        dictProtoMqtt = {}
        # TODO edit the broker address - removed for security reasons here
        dictProtoMqtt = {
            "sess" : myHostname,
            "dest" : toNode,
            "broker" : "changeMe",
